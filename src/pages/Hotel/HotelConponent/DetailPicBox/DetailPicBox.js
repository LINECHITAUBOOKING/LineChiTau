    ...
    return (
        <>
            <div className="detail-pic-box">
                <div className="material-symbols-outlined close-detail-pic my"
                    onClick={() => { props.setOpenPicBox(false) }}>
                    close
                </div>
                <div className="d-flex align-items-center justify-content-center">
                    <div class="material-symbols-outlined detail-pic-arrow"
                        onClick={() => {
                ...
                <div className="d-flex justify-content-center">
                    {pic.map((v, i) => {
                        return (
                            <div key={i} className="display-pic-select mx-2 my-4 p-0" onClick={() => { setPicNum(i) }}>
                                <img src={v} alt={v} className={picNum === i ? "display-pic-box-active" : "display-pic-box"} />
                            </div>
                        )
                    })}
                </div>
